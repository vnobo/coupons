package com.alex.wxmp.similarity;
...
/**
 * boot-cool-alliance CosineSimilarity
...
//        }
    ...
    public static double getSimilarityImpl(List<Word> words1, List<Word> words2) {
        ...
        double cos = BigDecimal.valueOf(ab.get()).divide(aabb, 9, RoundingMode.HALF_UP).doubleValue();
        return cos;
    }
